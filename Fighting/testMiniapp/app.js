...
App({
    data: {
        ...
        //自己的地址
        // imgbaseUrl: 'http://127.0.0.1/download',
        ...
        //新线上地址
        imgbaseUrl: "https://www.jxcloudlight.com/resources/",
        baseUrl: "https://www.jxcloudlight.com/enjoyLoveSpell",
    },
    onLaunch: function () {
        var that = this;
        // 展示本地存储能力
        ...
        wx.login({
            success: (res) => {
                ...
                that.request("/", "login", {}, (data, code, res) => {
                    //     console.log(1);
                    //     console.log(data);
                    //     console.log(2);
                    //     console.log(code);
